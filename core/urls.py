...
urlpatterns = [
    ...
    path('admin/users/card-print/add/<int:user_id>/', views.admin_add_card_print, name='admin_add_card_print'),
    path('admin/users/card-print/edit/<int:user_id>/', views.admin_edit_card_print, name='admin_edit_card_print'),
    path('admin/users/card-print/delete/<int:user_id>/', views.admin_delete_card_print, name='admin_delete_card_print'),
    ...
    path('admin/export/users/fields/', views.admin_export_fields_selection, name='admin_export_fields_selection'),
